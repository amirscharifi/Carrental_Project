...
public class OfferPageTest {
    ...
    @Test
    void checkShownOffer(){
        goDirectlyToOfferPage();

        assertThat(page.locator("#page-title")).hasText("Your offer");
        assertThat(page.locator("#offer-category")).hasText(carCategory.name());
        assertThat(page.locator("#offer-pickup-location")).hasText(location.name());
        assertThat(page.locator("#offer-return-location")).hasText(location.name());
        assertThat(page.locator("#offer-start-date")).hasText(startDate.toString());
        assertThat(page.locator("#offer-end-date")).hasText(endDate.toString());
        assertThat(page.locator("#offer-duration-days")).hasText(String.valueOf(duration));
        assertThat(page.locator("#offer-customer-status")).hasText(status.name());
        assertThat(page.locator("#offer-actual-location")).hasText(location.name());

        assertThat(page.locator("#price-base")).hasText(String.valueOf(priceBreakdown.basePrice()));
        assertThat(page.locator("#price-duration")).hasText(String.valueOf(priceBreakdown.durationDiscount()));
        assertThat(page.locator("#price-status-discount")).hasText("- " + priceBreakdown.statusDiscount());
        assertThat(page.locator("#price-relocation-fee")).hasText(String.valueOf(priceBreakdown.relocationFee()));
        assertThat(page.locator("#price-total")).hasText(String.valueOf(priceBreakdown.total()));

        page.locator("#confirm-reservation-button").click();
        assertThat(page.locator("#page-title")).hasText("Reservation confirmed");

    }

    private void goDirectlyToOfferPage() {
